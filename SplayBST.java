...
public class SplayBST<E extends Comparable<E>>
{
	...
	public E get(E thing){
        if( isEmpty( ) )
            return null;
            
        root = splay( thing, root );
     ...
     */
    private static <E> BinaryNode<E> rotateWithLeftChild( BinaryNode<E> k2 )
    {
     ...
     */
    private static <E> BinaryNode<E> rotateWithRightChild( BinaryNode<E> k1 )
    {
